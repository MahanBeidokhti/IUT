...
void sum(int number1_size, char number1[number1_size+1], int number2_size, char number2[number2_size+1])
{
    ...
    if (number1_size>=number2_size)
    {
        ...
        for (int i=number1_size; i>=0; i--)
        {
            ...
            if ((int) number2[i] -48 + (int) number1[i] -48 >=10)
                flag1 = 1;

            
            number1[i] = (char) (((int) number2[i] -48 + (int) number1[i] -48 )%10);
            ...
            if (flag2==1)
            {
                ...
                {
                    flag1 = 1;
                    number1[i] = (char)((int)number1[i]-9);
                }
                else 
    ...
    if (number2_size>number1_size)
    {
        ...
        for (int i=number2_size; i>=0; i--)
        {
            ...
            if ((int) number1[i] -48 + (int) number2[i] -48 >=10)
                flag1 = 1;

            
            number2[i] = (char) (((int) number1[i] -48 + (int) number2[i] -48 )%10);
            ...
            if (flag2==1)
            {
                ...
                {
                    flag1 = 1;
                    number2[i] = (char)((int)number2[i]-9);
                }
                else 
...
int main()
{
    ...
    sum(first_number_digit, first_num, second_number_digit, second_num);
}